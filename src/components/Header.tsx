    ...
    <header className="bg-white/90 backdrop-blur-xl border-b border-gray-200/60 sticky top-0 z-30 shadow-professional">
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-[#0A192F] bg-gradient-to-r from-[#0A192F] to-[#334155] bg-clip-text text-transparent">
        ...
        <div className="flex items-center gap-3">
          ...
          {isLoggedIn && (
            <div className="hidden md:flex items-center gap-3 px-4 py-2 bg-gradient-to-r from-slate-50 to-slate-100/50 rounded-xl border border-slate-200/50">
              <div className="w-9 h-9 bg-gradient-to-br from-[#0A192F] to-[#334155] rounded-full flex items-center justify-center shadow-md">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                {isLoggedIn ? (
                  ...
                  <Button 
                    onClick={onShowLogin}
                    className="bg-gradient-to-r from-[#0A192F] to-[#334155] hover:from-[#1e293b] hover:to-[#0A192F] text-white cursor-pointer transition-all duration-200 shadow-lg shadow-slate-900/30"
                  >
