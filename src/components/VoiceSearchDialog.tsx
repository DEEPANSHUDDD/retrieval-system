  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md border-0 shadow-2xl p-0 overflow-hidden">
        ...
        <div className="bg-gradient-to-br from-[#0A192F] via-[#1e293b] to-[#334155] p-8 text-white relative overflow-hidden">
            ...
            {isListening && (
              <>
                <motion.div
                  ...
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-slate-400 rounded-full blur-3xl"
                />
                <motion.div
                  animate={{
                    scale: [1, 1.3, 1],
                  ...
                  className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-slate-300 rounded-full blur-3xl"
                />
              </>
            )}
          </div>
