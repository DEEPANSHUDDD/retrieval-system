...
export function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  ...
  return (
    <div className="w-72 bg-gradient-to-b from-[#0A192F] via-[#112240] to-[#0A192F] min-h-screen flex flex-col shadow-2xl">
      {/* Logo Section */}
      <div className="p-6 border-b border-white/10">
        ...
        >
          <div className="relative">
            <div className="w-12 h-12 bg-gradient-to-br from-[#0A192F] to-[#112240] rounded-xl flex items-center justify-center shadow-lg shadow-black/20">
              ...
              >
                <button
                  ...
                  className={`w-full group relative flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${
                    isActive
                      ? 'bg-gradient-to-r from-white/10 to-white/5 text-white shadow-lg shadow-black/10'
