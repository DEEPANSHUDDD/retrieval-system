  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Accent Lines */}
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-white to-blue-500 opacity-30" />
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 via-white to-blue-500 opacity-30" />
          ...
          >
            <div className="mb-8">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-white text-xl font-semibold mb-1">Ministry of Education</h2>
                  <p className="text-white/70">Government of India</p>
                </div>
              </div>
              <h1 className="text-white mb-6 text-4xl font-bold leading-tight">
                Smart Information Retrieval System
              </h1>
              <p className="text-xl text-blue-200 mb-8">AI-powered Knowledge Access Portal</p>
          ...
          >
            <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl p-8 lg:p-10 border border-white/20">
              ...
              <div className="lg:hidden mb-8 text-center">
                ...
                <h2 className="text-slate-900 text-xl font-semibold mb-2">Welcome Back</h2>
                <p className="text-slate-600">Smart Information Retrieval System</p>
              </div>

              {/* Form Header */}
              <div className="text-center mb-8 hidden lg:block">
                <h2 className="text-slate-900 text-2xl font-semibold mb-2">Welcome Back</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 py-4 border-slate-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-12 pr-12 py-4 border-slate-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg"
                      required
                    />
                    <button
                      type="button"
                ...
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-4 text-lg shadow-lg group"
                >
                  Sign In
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Button
                    type="button"
                    variant="outline"
                    className="py-4 border-slate-300 hover:bg-slate-50"
                  >
            ...
            <div className="mt-6 text-center text-white/70 text-sm">
              <p>© 2025 Ministry of Education | Smart India Hackathon</p>
      ...
      {/* Corner Accents */}
      <div className="absolute top-0 left-0 w-32 h-32 border-t-4 border-l-4 border-blue-500/50 rounded-tl-3xl" />
