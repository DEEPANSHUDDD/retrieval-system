...
export function About() {
  ...
  const teamMembers = [
    { name: 'Rahul Kumar', role: 'Team Lead & Full Stack Developer', color: 'from-slate-600 to-slate-700' },
    { name: 'Priya Sharma', role: 'AI/ML Engineer', color: 'from-slate-700 to-slate-800' },
    { name: 'Amit Patel', role: 'Frontend Developer', color: 'from-slate-500 to-slate-600' },
    { name: 'Sneha Reddy', role: 'UI/UX Designer', color: 'from-slate-400 to-slate-500' },
    { name: 'Arjun Singh', role: 'Backend Developer', color: 'from-slate-800 to-slate-900' },
    { name: 'Kavya Iyer', role: 'Data Analyst', color: 'from-cyan-500 to-cyan-600' },
  ];

  const stats = [
    { value: '1,000+', label: 'Documents', gradient: 'from-slate-600 to-slate-700' },
    { value: '50+', label: 'Departments', gradient: 'from-slate-700 to-slate-800' },
    { value: '10K+', label: 'Users', gradient: 'from-slate-500 to-slate-600' },
    { value: '99.9%', label: 'Uptime', gradient: 'from-slate-800 to-slate-900' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-slate-50/30 to-gray-50">
      <div className="p-8 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            <div className="relative">
              <div className="w-24 h-24 bg-gradient-to-br from-[#0A192F] via-[#1e293b] to-[#334155] rounded-3xl flex items-center justify-center mx-auto shadow-2xl shadow-slate-900/30">
                <Globe className="w-12 h-12 text-white" />
              </div>
              <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-br from-[#334155] to-[#475569] rounded-full flex items-center justify-center shadow-lg">
        ...
        >
          <Card className="p-10 mb-16 border-0 shadow-2xl bg-gradient-to-br from-slate-50 via-gray-50 to-slate-50 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#334155]/20 to-transparent rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-[#0A192F]/20 to-transparent rounded-full blur-3xl" />
            
            <div className="max-w-4xl mx-auto text-center relative z-10">
              <div className="w-16 h-16 bg-gradient-to-br from-[#0A192F] to-[#334155] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl">
        ...
        >
          <Card className="p-10 mb-16 border-0 shadow-xl bg-white">
            <div className="text-center mb-8">
              <div className="w-14 h-14 bg-gradient-to-br from-[#334155] to-[#475569] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {techStack.map((tech, index) => (
                <motion.div
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-[#0A192F] to-[#334155] text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
                >
                  {tech}
                </motion.div>
              ))}
        ...
        >
          <Card className="p-12 border-0 shadow-2xl bg-gradient-to-br from-[#0A192F] via-[#1e293b] to-[#334155] text-white relative overflow-hidden">
            <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#334155]/20 rounded-full blur-3xl" />
            ...
            <div className="text-center max-w-2xl mx-auto relative z-10">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button className="bg-gradient-to-r from-[#334155] to-[#475569] hover:from-[#475569] hover:to-[#334155] text-white shadow-xl px-8 py-6">
